...
/** userLoginByWxMini GET /api/user/login/wx_mini */
export async function userLoginByWxMiniUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.userLoginByWxMiniUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseLoginUserVO_>("/api/user/login/wx_mini", {
    method: "GET",
    params: {
      ...params
    },
...
/** passwordReset POST /api/user/password/reset */
export async function passwordResetUsingPost(
