...
import * as newsFeedbackController from "./newsFeedbackController";
...
import * as userOperationLogController from "./userOperationLogController";
...
export default {
  ...
  newsTagController,
  newsController,
  newsFeedbackController,
  newsRecommendController,
  sensitiveWordController,
  userController,
  userOperationLogController,
